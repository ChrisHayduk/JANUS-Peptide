...
if not os.path.exists(output_file):
    ...
    sequences = generate_random_peptides(num_sequences=3, exclude_amino_acids=set(['C', 'M']))
...
janus = JANUS(
    # Required parameters
    work_dir="/home/jupyter/output",                    # Directory to store results
    ...
    generation_size=3,                            # Population size per generation
    num_exchanges=1,                               # Number of sequences to exchange
